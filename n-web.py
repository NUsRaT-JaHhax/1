# -*- coding: utf-8 -*-
#!/usr/bin/python2
# Author : Nabil-Rahman (■Error■)
# Team : ISR | Illegal_Secority_Team
# Team : Cyber_16 

# Fuck You Decrypter (+_×)
# You Can't Be A Pogrammer By Changing Logo ;)
# You Can't See Change Expect You Never Do Anything Differently !
...
def intro():
   ...
   # os.system('xdg-open https://facebook.com/groups/368007073698875')
    ...
    print blue+"[\033[1;31m19\033[1;94m] \033[1;35m>>\033[1;32m Wp BruteForce"
    print blue+"[\033[1;31m20\033[1;94m] \033[1;35m>>\033[1;32m Sqli Scanner"
    print blue+"[\033[1;31m21\033[1;94m] \033[1;35m>>\033[1;32m Directory BruteForce"
    print blue+"[\033[1;31m22\033[1;94m] \033[1;35m>>\033[1;32m Help?"
    print blue+"[\033[1;31m23\033[1;94m] \033[1;35m>>\033[1;32m About"
   ...
   # choise condition
    if user_choise == "1":
       os.system('cd files && python xc.py')
    elif user_choise == "2":
         ...
         os.system('cd .. && python2 wp-scan.py')
    elif user_choise == "18":
...
def up_chker():
    ...
    if r != ver:
       ...
       try:
             ...
             print (logo)
             print 
             print (red+"[+] "'\033[1;35mGETTING UPDATES '+red+'[+]')
             time.sleep(1)
             os.system("rm -rf N-Web && git clone https://github.com/Nabil-Official/N-WEB")
             print 
             print (yellow+'[+] UPDATE FINISHED [+]')
             print (yellow+'[+] RESTART THE SCRIPT [+]')
             time.sleep(2)
